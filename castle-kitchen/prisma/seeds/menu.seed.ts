...
export async function seedMenu(prisma: any) {
  await prisma.product.createMany({
    data: [
...

      {
        ...
        appType: AppType.RESTAURANT,
        name: 'Rib Eye Steak',
        description: 'Tender rib eye steak',
        price: 185000,
        stock: 40,
      },

      {
        ...
        description: 'Premium tenderloin cut',
        price: 220000,
        stock: 35,
      },

      {
        ...
        appType: AppType.RESTAURANT,
        name: 'T-Bone Steak',
        description: 'Classic bone-in steak',
        price: 250000,
        stock: 25,
      },
...

      {
        ...
        appType: AppType.RESTAURANT,
        name: 'Tomahawk Steak',
        description: 'Large bone-in rib steak',
        price: 550000,
        stock: 10,
      },

      {
        ...
        description: 'Premium porterhouse cut',
        price: 350000,
        stock: 20,
      },

      {
        ...
        description: 'Classic striploin steak',
        price: 210000,
        stock: 30,
      },

      {
        ...
        appType: AppType.RESTAURANT,
        name: 'Flank Steak',
        description: 'Flavorful flank steak',
        price: 165000,
        stock: 30,
      },

      {
        ...
        appType: AppType.RESTAURANT,
        name: 'Skirt Steak',
        description: 'Tender grilled skirt steak',
        price: 170000,
        stock: 30,
      },
...

      {
        ...
        appType: AppType.RESTAURANT,
        name: 'Iced Coffee',
        description: 'Chilled premium coffee',
        price: 28000,
        stock: 120,
      },
  ...
  console.log('✅ 25 menu items seeded');
}
