...
export async function seedCatalog(prisma: any) {
  await prisma.product.createMany({
    data: [
...

      {
        ...
        appType: AppType.ECOMMERCE,
        name: 'USB-C Hub',
        description: 'Multi-port USB-C expansion hub',
        price: 499000,
        stock: 60,
      },
...

      {
        ...
        description: 'Premium hot-swappable keyboard',
        price: 1599000,
        stock: 18,
      },
...

      {
        ...
        appType: AppType.ECOMMERCE,
        name: 'HDMI Cable',
        description: '4K Ultra HD HDMI cable',
        price: 99000,
        stock: 120,
      },
...

      {
        ...
        appType: AppType.ECOMMERCE,
        name: 'Mesh WiFi Node',
        description: 'Expand wireless network coverage',
        price: 1199000,
        stock: 18,
      },
...

      {
        ...
        description: 'Business-grade access point',
        price: 1499000,
        stock: 15,
      },
  ...
  console.log('✅ 30 catalog items seeded');
}
