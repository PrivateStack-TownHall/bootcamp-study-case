export async function seedCoffeeImages(prisma: any) {
  await prisma.productImage.createMany({
    data: [
      ...
      },
      {
        productId: 9,
        imageUrl:
          'https://images.unsplash.com/photo-1521302080371-df0e5f31d8f6',
        sortOrder: 2,
      },

      {
        productId: 10,
        imageUrl: 'https://images.unsplash.com/photo-1522992319-0365e5f11656',
        sortOrder: 1,
      },
      {
        productId: 10,
  ...
  console.log('✅ 58 coffee images seeded');
}
